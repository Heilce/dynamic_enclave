...
tools/bugpoint-passes/BugpointPasses.exports: /root/piecewise/src/llvm-4.0.0.src/tools/bugpoint-passes/bugpoint.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/piecewise/src/build-llvm/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for BugpointPasses"
	cd /root/piecewise/src/build-llvm/tools/bugpoint-passes && echo { > BugpointPasses.exports
	cd /root/piecewise/src/build-llvm/tools/bugpoint-passes && grep -q [[:alnum:]] /root/piecewise/src/llvm-4.0.0.src/tools/bugpoint-passes/bugpoint.exports && echo "  global:" >> BugpointPasses.exports || :
	cd /root/piecewise/src/build-llvm/tools/bugpoint-passes && sed -e "s/\$$/;/" -e "s/^/    /" < /root/piecewise/src/llvm-4.0.0.src/tools/bugpoint-passes/bugpoint.exports >> BugpointPasses.exports
	cd /root/piecewise/src/build-llvm/tools/bugpoint-passes && echo "  local: *;" >> BugpointPasses.exports
	cd /root/piecewise/src/build-llvm/tools/bugpoint-passes && echo "};" >> BugpointPasses.exports
...
tools/bugpoint-passes/CMakeFiles/BugpointPasses_exports.dir/clean:
	cd /root/piecewise/src/build-llvm/tools/bugpoint-passes && $(CMAKE_COMMAND) -P CMakeFiles/BugpointPasses_exports.dir/cmake_clean.cmake
