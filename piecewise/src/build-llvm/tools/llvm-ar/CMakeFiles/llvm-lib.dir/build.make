...
bin/llvm-lib: bin/llvm-ar
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/piecewise/src/build-llvm/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating ../../bin/llvm-lib"
	cd /root/piecewise/src/build-llvm/tools/llvm-ar && /usr/bin/cmake -E create_symlink llvm-ar /root/piecewise/src/build-llvm/./bin/llvm-lib
...
tools/llvm-ar/CMakeFiles/llvm-lib.dir/clean:
	cd /root/piecewise/src/build-llvm/tools/llvm-ar && $(CMAKE_COMMAND) -P CMakeFiles/llvm-lib.dir/cmake_clean.cmake
.PHONY : tools/llvm-ar/CMakeFiles/llvm-lib.dir/clean

tools/llvm-ar/CMakeFiles/llvm-lib.dir/depend:
	cd /root/piecewise/src/build-llvm && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/piecewise/src/llvm-4.0.0.src /root/piecewise/src/llvm-4.0.0.src/tools/llvm-ar /root/piecewise/src/build-llvm /root/piecewise/src/build-llvm/tools/llvm-ar /root/piecewise/src/build-llvm/tools/llvm-ar/CMakeFiles/llvm-lib.dir/DependInfo.cmake --color=$(COLOR)
