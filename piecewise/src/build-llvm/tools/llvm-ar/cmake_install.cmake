# Install script for directory: /root/piecewise/src/llvm-4.0.0.src/tools/llvm-ar
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-arx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/root/piecewise/src/build-llvm/bin/llvm-ar")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-ranlibx" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/root/piecewise/src/llvm-4.0.0.src/cmake/modules/LLVMInstallSymlink.cmake")
endif()
