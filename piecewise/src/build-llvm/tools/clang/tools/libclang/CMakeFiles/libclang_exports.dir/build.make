...
tools/clang/tools/libclang/CMakeFiles/libclang_exports: /root/piecewise/src/llvm-4.0.0.src/tools/clang/tools/libclang/libclang.exports


tools/clang/tools/libclang/libclang.exports: /root/piecewise/src/llvm-4.0.0.src/tools/clang/tools/libclang/libclang.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/piecewise/src/build-llvm/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for libclang"
	cd /root/piecewise/src/build-llvm/tools/clang/tools/libclang && echo { > libclang.exports
	cd /root/piecewise/src/build-llvm/tools/clang/tools/libclang && grep -q [[:alnum:]] /root/piecewise/src/llvm-4.0.0.src/tools/clang/tools/libclang/libclang.exports && echo "  global:" >> libclang.exports || :
	cd /root/piecewise/src/build-llvm/tools/clang/tools/libclang && sed -e "s/\$$/;/" -e "s/^/    /" < /root/piecewise/src/llvm-4.0.0.src/tools/clang/tools/libclang/libclang.exports >> libclang.exports
	cd /root/piecewise/src/build-llvm/tools/clang/tools/libclang && echo "  local: *;" >> libclang.exports
	cd /root/piecewise/src/build-llvm/tools/clang/tools/libclang && echo "};" >> libclang.exports
...
tools/clang/tools/libclang/CMakeFiles/libclang_exports.dir/clean:
	cd /root/piecewise/src/build-llvm/tools/clang/tools/libclang && $(CMAKE_COMMAND) -P CMakeFiles/libclang_exports.dir/cmake_clean.cmake
