...
tools/clang/test/CMakeFiles/check-clang-cxx-basic-basic.lookup-basic.lookup.qual-class.qual:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/piecewise/src/build-llvm/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /root/piecewise/src/llvm-4.0.0.src/tools/clang/test/CXX/basic/basic.lookup/basic.lookup.qual/class.qual"
...
tools/clang/test/CMakeFiles/check-clang-cxx-basic-basic.lookup-basic.lookup.qual-class.qual.dir/clean:
	cd /root/piecewise/src/build-llvm/tools/clang/test && $(CMAKE_COMMAND) -P CMakeFiles/check-clang-cxx-basic-basic.lookup-basic.lookup.qual-class.qual.dir/cmake_clean.cmake
