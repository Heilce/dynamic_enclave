...
tools/clang/test/CMakeFiles/check-clang-cxx-dcl.decl-dcl.init:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/piecewise/src/build-llvm/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /root/piecewise/src/llvm-4.0.0.src/tools/clang/test/CXX/dcl.decl/dcl.init"
	cd /root/piecewise/src/build-llvm/tools/clang/test && /usr/bin/python2.7 /root/piecewise/src/llvm-4.0.0.src/utils/lit/lit.py -sv --param clang_site_config=/root/piecewise/src/build-llvm/tools/clang/test/lit.site.cfg /root/piecewise/src/llvm-4.0.0.src/tools/clang/test/CXX/dcl.decl/dcl.init
...
tools/clang/test/CMakeFiles/check-clang-cxx-dcl.decl-dcl.init.dir/clean:
	cd /root/piecewise/src/build-llvm/tools/clang/test && $(CMAKE_COMMAND) -P CMakeFiles/check-clang-cxx-dcl.decl-dcl.init.dir/cmake_clean.cmake
