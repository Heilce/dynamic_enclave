...
tools/clang/test/CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class-temp.mem.enum:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/piecewise/src/build-llvm/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /root/piecewise/src/llvm-4.0.0.src/tools/clang/test/CXX/temp/temp.decls/temp.class/temp.mem.enum"
...
tools/clang/test/CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class-temp.mem.enum.dir/clean:
	cd /root/piecewise/src/build-llvm/tools/clang/test && $(CMAKE_COMMAND) -P CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class-temp.mem.enum.dir/cmake_clean.cmake
