...
test/CMakeFiles/check-llvm-analysis-postdominators:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/piecewise/src/build-llvm/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /root/piecewise/src/llvm-4.0.0.src/test/Analysis/PostDominators"
	cd /root/piecewise/src/build-llvm/test && /usr/bin/python2.7 /root/piecewise/src/llvm-4.0.0.src/utils/lit/lit.py -sv --param llvm_site_config=/root/piecewise/src/build-llvm/test/lit.site.cfg --param llvm_unit_site_config=/root/piecewise/src/build-llvm/test/Unit/lit.site.cfg /root/piecewise/src/llvm-4.0.0.src/test/Analysis/PostDominators
...
test/CMakeFiles/check-llvm-analysis-postdominators.dir/clean:
	cd /root/piecewise/src/build-llvm/test && $(CMAKE_COMMAND) -P CMakeFiles/check-llvm-analysis-postdominators.dir/cmake_clean.cmake
...
test/CMakeFiles/check-llvm-analysis-postdominators.dir/depend:
	cd /root/piecewise/src/build-llvm && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/piecewise/src/llvm-4.0.0.src /root/piecewise/src/llvm-4.0.0.src/test /root/piecewise/src/build-llvm /root/piecewise/src/build-llvm/test /root/piecewise/src/build-llvm/test/CMakeFiles/check-llvm-analysis-postdominators.dir/DependInfo.cmake --color=$(COLOR)
