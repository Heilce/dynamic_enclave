...
static int register_file(const char* uri, const char* checksum_str, bool check_duplicates) {
    int ret;
    log_always("chenypregister_file=%s\n",uri);
    ...
    if (checksum_str) {
        ...
        log_always("_DkStreamAttributesQuery");
...
int init_trusted_files(void) {
    ...
    log_always("init_trusted_files_from_toml_table");
    ...
    log_always("init_trusted_files_from_toml_array");
