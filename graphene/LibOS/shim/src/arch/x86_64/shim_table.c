...
shim_fp shim_table[LIBOS_SYSCALL_BOUND] = {
    ...
    [__NR_socket]                 = (shim_fp)0,//shim_do_socket,
    [__NR_connect]                = (shim_fp)0,//shim_do_connect,
    [__NR_accept]                 = (shim_fp)0,//shim_do_accept,
    [__NR_sendto]                 = (shim_fp)0,//shim_do_sendto,
    [__NR_recvfrom]               = (shim_fp)0,//shim_do_recvfrom,
    [__NR_sendmsg]                = (shim_fp)0,//shim_do_sendmsg,
    [__NR_recvmsg]                = (shim_fp)0,//shim_do_recvmsg,
    [__NR_shutdown]               = (shim_fp)0,//shim_do_shutdown,
    [__NR_bind]                   = (shim_fp)0,//shim_do_bind,
    [__NR_listen]                 = (shim_fp)0,//shim_do_listen,
    [__NR_getsockname]            = (shim_fp)0,//shim_do_getsockname,
    [__NR_getpeername]            = (shim_fp)0,//shim_do_getpeername,
    [__NR_socketpair]             = (shim_fp)0,//shim_do_socketpair,
    [__NR_setsockopt]             = (shim_fp)0,//shim_do_setsockopt,
    [__NR_getsockopt]             = (shim_fp)0,//shim_do_getsockopt,
    ...
    [__NR_accept4]                = (shim_fp)0,//shim_do_accept4,
    ...
    [__NR_recvmmsg]               = (shim_fp)0,//shim_do_recvmmsg,
    ...
    [__NR_sendmmsg]               = (shim_fp)0,//shim_do_sendmmsg,
