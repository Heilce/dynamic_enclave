...
noreturn static void __shim_do_execve_rtld(struct execve_rtld_arg* __arg) {
    log_always("__shim_do_execve_rtld\n");
    ...
    log_debug("execve: start execution__end\n");
    /* NOTREACHED */
